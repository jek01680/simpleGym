 ...
 * @author STU-13
 */
public class AdminMemberFrame extends javax.swing.JFrame implements ActionListener{
    private MemberDAO dao;
    private MemberDTO dto;
    private AdminFrame Af;
    /**
     * Creates new form AdminMemberFrame
     */
    ...
    public AdminMemberFrame(AdminFrame Af,MemberDTO dto){
        this();
    ...
    private void initComponents() {
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGap(42, 42, 42)
                .addComponent(btDel, javax.swing.GroupLayout.PREFERRED_SIZE, 96, javax.swing.GroupLayout.PREFERRED_SIZE)
        ...
        layout.setVerticalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, layout.createSequentialGroup()
                ...
                .addGap(39, 39, 39)
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(btDel, javax.swing.GroupLayout.PREFERRED_SIZE, 44, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AdminMemberFrame.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new AdminMemberFrame().setVisible(true);
            }
        });
    }
    ...
    private void adminEdit() throws SQLException {
        //1
    ...
    private void adminDel() throws SQLException {
        int cnt = dao.deleteMember(dto.getMemEmail());
        System.out.println("삭제결과 cnt= "+cnt);
